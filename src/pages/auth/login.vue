<template>
  <div class="flex justify-center items-center h-full">
    ...
    >
      ...
      <div class="absolute top-[45%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-blue-50 text-[20px]">
        鸿鹄，指的是大雁和天鹅，常用以比喻志向高远、才情出众的人。在古代文人墨客的诗词中，"鸿鹄"常被用来代表对理想和目标的追求，象征着非凡的抱负和希望。
      </div>
    </div>
    <!-- 右侧-->
    <div class="relative transition-all duration-300 w-full h-full sm:w-7/12 md:w-5/12 lg:w-4/12 xl:w-3/12">
      <!--  输入部分    -->
      <div class="w-4/5 h-auto absolute top-[45%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col">
        <!--    欢迎    -->
        <div class="mt-6 text-3xl font-bold text-gray-900 text-center">欢迎登录</div>
        <el-form :model="loginInfo" :rules="loginFormRules" ref="ruleFormRef">
          <el-form-item class="login-from__label" label="账号" label-position="top" prop="userName">
            <el-input
              placeholder="请输入账号"
          ...
          <el-form-item class="login-from__label" label="密码" label-position="top" prop="password">
            <el-input
              type="password"
